...
const CARD_BG = 'rgba(250, 252, 255, 0.92)';
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        {/* Bottom tab bar – solid white */}
        <View style={styles.tabBar}>
          <View style={styles.tabItem}>
            <FontAwesome name="search" size={22} color={HOWARD_RED} />
            <Text style={[styles.tabLabel, { color: HOWARD_RED }]}>Search</Text>
          </View>
          <View style={styles.tabItem}>
            <FontAwesome name="user-o" size={22} color="#888" />
            <Text style={styles.tabLabel}>My Account</Text>
          </View>
          <View style={styles.tabItem}>
            <FontAwesome name="book" size={22} color="#888" />
            <Text style={styles.tabLabel}>E-Resources</Text>
          </View>
          <View style={styles.tabItem}>
            <FontAwesome name="map-o" size={22} color="#888" />
