...
export default function NewArrivalsScreen() {
  ...
  const loadPage = useCallback(async (pageNum: number, isRefresh: boolean) => {
    ...
    try {
      ...
      const msg = e instanceof BooksApiError ? e.message : 'Could not load new arrivals';
      setError(msg);
  ...
  const header = (
    <View style={styles.header}>
      ...
      <View style={styles.headerTitleWrap}>
        ...
        <Text style={styles.headerSub}>Recently added to the catalog</Text>
      </View>
